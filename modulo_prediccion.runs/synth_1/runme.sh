...
HD_PWD='C:/Users/sarto/practico_move/practico_move.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log predict_stage.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source predict_stage.tcl
